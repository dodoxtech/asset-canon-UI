...
export const SHEETS: Record<string, string> = {
  // Hero (Pix)
  "pix-idle-tired": "sprites/pix-idle-tired-sheet-320x240.json",
  "pix-idle": "sprites/pix-idle-sheet-320x240.json",
  "pix-walk": "sprites/pix-walk-sheet-704x264.json",
  "pix-pickup": "sprites/pix-pickup-sheet-528x264.json",
  // Companion (Cano)
  "cano-float": "sprites/cano-float-sheet-720x180.json",
  "cano-react": "sprites/cano-react-sheet-384x192.json",
  "cano-point": "sprites/cano-point-sheet-432x216.json",
  // Collectibles
  "shard-canon": "sprites/shard-canon-sheet-512x128.json",
  "shard-pipeline": "sprites/shard-pipeline-sheet-768x192.json",
  "shard-keyring": "sprites/shard-keyring-sheet-832x208.json",
  "shard-rune": "sprites/shard-rune-sheet-512x128.json",
  "shard-cog": "sprites/shard-cog-sheet-640x160.json",
  "key-canon": "sprites/key-canon-sheet-832x208.json",
  coin: "sprites/coin-sheet-576x144.json",
  "sticker-easteregg": "sprites/sticker-easteregg-sheet-256x128.json",
  "canon-artifact": "sprites/canon-artifact-sheet-512x256.json",
  // Animated props & doors
  "prop-lamp": "sprites/prop-lamp-sheet-288x216.json",
  "prop-conveyor-belt": "sprites/prop-conveyor-belt-sheet-896x224.json",
  "prop-pipeline-nodes": "sprites/prop-pipeline-nodes-sheet-1056x352.json",
  "prop-frame-empty": "sprites/prop-frame-empty-sheet-168x168.json",
  "prop-frame-lit": "sprites/prop-frame-lit-sheet-840x168.json",
  "prop-scroll-shelf": "sprites/prop-scroll-shelf-sheet-960x240.json",
  "prop-furnace": "sprites/prop-furnace-sheet-1280x256.json",
  "prop-anvil-sparks": "sprites/prop-anvil-sparks-sheet-480x160.json",
  "door-locked": "sprites/door-locked-sheet-144x192.json",
  "door-lockbreak": "sprites/door-lockbreak-sheet-648x288.json",
  "door-open": "sprites/door-open-sheet-480x320.json",
  "prop-chest": "sprites/prop-chest-sheet-896x168.json",
  // Cutscene / FX
  "fx-sparkle": "sprites/fx-sparkle-sheet-576x144.json",
  "fx-dust-puff": "sprites/fx-dust-puff-sheet-384x128.json",
  "fx-dust-motes": "sprites/fx-dust-motes-sheet-640x160.json",
  "fx-assemble-glow": "sprites/fx-assemble-glow-sheet-1536x192.json",
}
